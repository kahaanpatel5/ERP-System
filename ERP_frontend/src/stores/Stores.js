...
///////////////////////////////////////////TOGGLE BETWEEN THE STOCK CHECK RADIO BUTTONS//////////
  ...
  submitmrn=(e)=>{
    e.preventDefault()
    axios.post('http://localhost:3000/store/mrn',
  ...
  submitnewenrty=(e)=>{
   e.preventDefault()
   axios.post('http://localhost:3000/store/entry',
   {
 ...
 submitavailcheck=(e)=>{
  ...
  if(this.state.searchin==="all"&& this.state.searchby==="partnumber"){
    axios.post('http://localhost:3000/store/query',{
      "C_all":true,
      "C_partno":true,
 ...
 submithistoryfetch=(e)=>{
  e.preventDefault()
 axios.post('http://localhost:3000/store/query/history',{
